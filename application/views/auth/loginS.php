...
<div class="container-fluid text-center pt-2" style="background-color: dimgray; color:white; padding-bottom: 10px;">
    <table>
        <tr>
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-2">
                                ...
                                <form class="user" method="post" action="<?= base_url('auth/loginS'); ?>">
                                    <div class="form-group mb-4 textbox">
                                        <i class="fas fa-user"></i>
                                        <input type="text" id="username" name="username" value="<?= set_value('username'); ?>" placeholder="Enter NIS...">
                                    </div>
                                    ...
                                    <div class="from-group mb-5 textbox">
                                        ...
                                        <?= form_error('password', '<small class="text-danger pl-3" style="font-size: 25px;">', '</small>'); ?>
                                    </div>
                                ...
                                <hr>
                                <div class="text-right mt-4" style="margin-bottom: -25px;">
