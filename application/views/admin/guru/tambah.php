...
<div class="container-fluid">
    ...
    <div class="row justify-content-center">
        <div class="card mb-5">
            ...
            <form action="<?= base_url('admin/tambahGuru'); ?>" id="tambah" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <label for="alamat" class="mt-4 mb-5">Alamat :</label><br>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" id="password" name="password" minlength="3" placeholder="Password">
                            </div>
